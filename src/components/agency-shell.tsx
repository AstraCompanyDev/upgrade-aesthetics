  ...
  return (
    <div className="flex min-h-screen">
      <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col bg-sidebar px-5 py-6 text-sidebar-foreground lg:flex">
        <Link to="/agency" className="flex items-center px-2" aria-label="ZeeWork home">
        ...
        <div className="mt-auto rounded-xl bg-sidebar-accent/60 p-4">
          <p className="font-display text-sm font-semibold">Grow your bench</p>
          <p className="mt-1 text-xs text-sidebar-foreground/70">
            Invite specialists so you can bid on bigger retainers.
          </p>
          <Link
            to="/agency/profile"
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-20 flex items-center gap-4 border-b border-border bg-background/80 px-5 py-4 backdrop-blur-md lg:px-10">
          ...
          <div className="relative hidden max-w-md flex-1 md:block">
            ...
            <input
              type="search"
              placeholder="Search contracts, members, clients"
              aria-label="Search"
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden text-sm font-medium sm:block">HypoMass</span>
            </Link>
          </div>
        </header>
